...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline.to("#yellow-box", {x: 200, rotation: 360, borderRadius: "100%"});

    timeline.to("#yellow-box", {y: 300, scale: 2});

    timeline.to("#yellow-box", {x: 400, scale: 1, rotation: 360, borderRadius: "8px"});
